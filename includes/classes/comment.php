...
class Comment {
    ...
    public function create(){
        ...
        if($numResponse > 0){
            $viewRepliesText = "<span class='repliesSection viewReplies' onClick='getReplies($id, this, $videoId)'>
                                View all $numResponse replies</span>";
        }else{
    ...
    public function getReplies(){
        $query = $this->con->prepare("SELECT * FROM comments WHERE responseTo=:responseTo ORDER BY datePosted ASC");
